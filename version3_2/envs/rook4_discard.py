...
class RookEnv(gym.Env):
    def __init__(self, map_file: str, reward_dict: dict, max_steps: int = 100, seed: int = None):
        ...
        # self.trajectory_record = np.zeros()
        

    def _load_map(self, map_file: str) -> Map:
        # print("_load_map is called")
        """
    ...
    def _construct_state(self, map: Map) -> np.ndarray:
        # print("_construct_state is called")
        """
    ...
    def _check_valid_position(self, map: Map, marker: int, pos: tuple) -> bool:
        # print("_check_valid_position is called")
        """
    ...
    def _check_valid_move(self, map: Map, marker: int, direction: int) -> bool:
        # print("_check_valid_move is called")
        """
    ...
    def _move_marker(self, map:Map, marker: int, direction: int) -> Map:
        ...
        # print("in move marker", map.trajectory.copy())
    ...
    def _calculate_reward(self, old_map: Map, new_map: Map, marker: int, direction: int) -> float:
        # print("_calculate_reward is called")
        """
        ...
        #     reward += self.reward_dict["trajectory_distance_bonus"] * distance_reduce
        ...
        #     reward += self.reward_dict["merge_bonus"] * (new_map.n_markers) * prev_merge_num
    ...
    def _construct_info(self, map: Map) -> dict:
        # print("_construct_info is called")
        """
